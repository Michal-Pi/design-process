...
// Install design-os git pre-commit hook that scans staged files for PII.
//
...
for FILE in $STAGED; do
  ...
  case "$FILE" in
    design/research/*|*transcript*.md)
      ...
      if ! npx tsx bin/design-os.mjs scan --pii "$FILE"; then
        echo "design-os: PII found in $FILE — commit blocked. Use 'design-os install-hooks' to update allowlist."
        FAILED=1
      fi
      ;;
  esac
...
/**
 * Install the design-os pre-commit hook in the current git repository.
 *
