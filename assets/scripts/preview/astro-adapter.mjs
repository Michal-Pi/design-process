...
// Astro 5 preview adapter for the complete-design preview harness.
...
//          STACK.md (Astro 5.x), complete-design-mrd-v2.md §3.11

import { allocatePort } from '../port-manager.mjs';
import { scrubEnvForPreview } from '../security-sandbox.mjs';

/**
 * Prepare an Astro 5 dev server spawn configuration.
 *
